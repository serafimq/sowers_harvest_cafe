...
const breakfastDishes: Dish[] = [
  {
    ...
    description:
      'A fluffy omelet filled with a delicious blend of cheddar, provolone, and swiss cheese.',
  ...
  },
  {
    ...
    description:
      'A flavorful omelet packed with onions, tomatoes, olives, spinach, and feta cheese.',
  ...
  },
  {
    ...
    description:
      'A nutritious omelet filled with onions, peppers, tomatoes, mushrooms, spinach, housemade pesto, and provolone cheese.',
    ingredients: [
      'Eggs',
      'Onions',
      'Peppers',
  ...
  },
  {
    ...
    description:
      'A wholesome omelet with turkey, onions, peppers, spinach, swiss cheese, and a hint of garlic.',
  ...
  },
  {
    ...
    description:
      'Thick slices of golden-brown French toast, served with whipped cream, maple syrup, and a choice of chocolate chips, blueberries, strawberries, or pecans.',
  ...
  },
  {
    ...
    description:
      'A refreshing parfait featuring organic yogurt, housemade granola, and your choice of two fruits: strawberries, blueberries, pineapples, mangoes, or bananas.',
  ...
  },
  {
    ...
    description:
      'A healthy selection of three fresh fruits, including strawberries, blueberries, bananas, and pineapples.',
  ...
  },
  {
    ...
    description:
      'A hearty breakfast sandwich with turkey, onions, peppers, spinach, swiss cheese, and a touch of garlic mayo.',
  ...
  },
  {
    ...
    description:
      'A savory sandwich featuring portabella mushrooms, provolone cheese, and housemade pesto.',
...
const saladDishes: Dish[] = [
  {
    ...
    description:
      'A refreshing salad with fresh spinach, turkey, feta cheese, apples, pecans, and housemade honey poppy seed dressing.',
  ...
  },
  {
    ...
    description:
      'A mix of lettuce, onions, peppers, tomatoes, mushrooms, shredded cheese, and ranch dressing.',
    ingredients: [
      'Lettuce mix',
      'Onions',
      'Peppers',
  ...
  },
  {
    ...
    description:
      'A Greek-style salad with romaine lettuce, onions, peppers, tomatoes, olives, feta cheese, and Greek dressing.',
    ingredients: [
      'Romaine lettuce',
      'Onions',
      'Peppers',
  ...
  },
  {
    ...
    description:
      'A zesty salad featuring lettuce mix, onions, chicken with hot sauce, bleu cheese, shredded cheese, and bleu cheese dressing.',
    ingredients: [
      'Lettuce mix',
      'Onions',
      'Chicken',
  ...
  },
  {
    ...
    description:
      'A timeless Caesar salad with romaine lettuce, grilled chicken, croutons, parmesan cheese, and creamy Caesar dressing.',
  ...
  },
  {
    ...
    description:
      'A tropical twist on a salad, featuring lettuce mix, BBQ chicken, onions, pineapple, shredded cheese, and ranch dressing.',
    ingredients: [
      'Lettuce mix',
      'BBQ chicken',
      'Onions',
  ...
  },
  {
    ...
    description:
      'A light salad with fresh lettuce, onions, peppers, tomatoes, mushrooms, shredded cheese, and a choice of dressing.',
    ingredients: [
      'Lettuce',
      'Onions',
      'Peppers',
...
const burgerDishes: Dish[] = [
  {
    ...
    description:
      'A smoky BBQ burger with housemade sauce, mayo, and a perfectly grilled beef patty.',
  ...
  },
  {
    ...
    description:
      'A juicy beef patty topped with housemade BBQ sauce, mayo, and melted American cheese.',
  ...
  },
  {
    ...
    description:
      'A tropical burger with housemade BBQ sauce, chipotle mayo, pineapple, bacon, and provolone cheese.',
    ingredients: [
      'Beef patty',
      'BBQ sauce',
      'Chipotle mayo',
...
const drinks: Dish[] = [
  {
    ...
    description:
      'Насладитесь нашей коллекцией премиального пива в бутылках от лучших производителей во всем мире.',
    ingredients: [
      'Stella',
      'Blue Moon',
      'Red Stripe',
  ...
  },
  {
    ...
    description:
      'Варится по уникальному рецепту нашего пивовара с использованием лучших сортов хмеля и солода.',
  ...
  },
  {
    ...
    description:
      'Приготовленный вручную лимонад с свежевыжатым лимонным соком, мятой и тростниковым сахаром.',
...
// Combine all dishes
const initialDishes: Dish[] = [...breakfastDishes, ...saladDishes, ...burgerDishes, ...drinks];
...
export { favoriteDishes, breakfastDishes, saladDishes, burgerDishes, drinks };
